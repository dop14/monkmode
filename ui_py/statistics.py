...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(655, 750)
        Form.setMinimumSize(QSize(630, 720))
        Form.setMaximumSize(QSize(658, 750))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 624, 1958))
        ...
        sizePolicy.setHeightForWidth(self.focusFrame.sizePolicy().hasHeightForWidth())
        self.focusFrame.setSizePolicy(sizePolicy)
        ...
        self.subjectAllBarFrame.setMaximumSize(QSize(600, 420))
