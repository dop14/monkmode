...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionnotify_when_session_starts_2 = QAction(MainWindow)
        self.actionnotify_when_session_starts_2.setObjectName(u"actionnotify_when_session_starts_2")
        self.actionnotifty_when_session_ends = QAction(MainWindow)
        self.actionnotifty_when_session_ends.setObjectName(u"actionnotifty_when_session_ends")
        ...
        self.menunotifications.addAction(self.actionnotify_when_session_starts_2)
        self.menunotifications.addAction(self.actionnotifty_when_session_ends)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionnotify_when_session_starts.setText(QCoreApplication.translate("MainWindow", u"play sound when session starts", None))
        self.actionnotify_when_session_ends.setText(QCoreApplication.translate("MainWindow", u"play sound when session starts", None))
        ...
        self.actionnotify_when_session_starts_2.setText(QCoreApplication.translate("MainWindow", u"notify when session starts", None))
        self.actionnotifty_when_session_ends.setText(QCoreApplication.translate("MainWindow", u"notifty when session ends", None))
