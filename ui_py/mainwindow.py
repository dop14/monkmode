...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menutheme.addAction(self.actionCOMING_SOON_4)
        self.menuset_week.addAction(self.actionweekdays_only)
        self.menuset_week.addAction(self.actionwhole_week)
        self.menunotifications.addAction(self.all_notifications)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actiontips_and_quotes.setText(QCoreApplication.translate("MainWindow", u"tips and quotes (COMING SOON)", None))
        ...
        self.streak_label.setText(QCoreApplication.translate("MainWindow", u"streaks heatmap: coming soon", None))
