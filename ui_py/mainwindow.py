...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.quoteFrame.sizePolicy().hasHeightForWidth())
        self.quoteFrame.setSizePolicy(sizePolicy1)
        self.quoteFrame.setMinimumSize(QSize(490, 0))
        ...
        sizePolicy3.setHeightForWidth(self.quote_label.sizePolicy().hasHeightForWidth())
