...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.popup_break_start = QAction(MainWindow)
        self.popup_break_start.setObjectName(u"popup_break_start")
        self.popup_break_start.setCheckable(True)
        ...
        self.menunotifications.addAction(self.popup_break_start)
        self.menunotifications.addAction(self.sound_break_start)
        self.menunotifications.addAction(self.popup_focus_start)
        self.menunotifications.addAction(self.sound_focus_start)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.popup_break_start.setText(QCoreApplication.translate("MainWindow", u"play sound when focus period starts", None))
        self.sound_break_start.setText(QCoreApplication.translate("MainWindow", u"play sound when break period starts", None))
